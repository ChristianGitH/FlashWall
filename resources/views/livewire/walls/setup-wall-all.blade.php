        ...
        <div class="max-w-full overflow-hidden pb-1" x-data="{ wall_background_choice: @entangle('background_choice') }">
            ...
            <div x-show="wall_background_choice == 1" class="max-w-full overflow-hidden">
                ...
                @elseif($background_image)
                    <img src="{{ asset('storage/' . (str_contains($wall->background_image, '/') ? $wall->background_image : 'walls_images/background_images/' . $wall->background_image)) }}" class="max-w-xs mx-auto shadow-md object-cover" inline />
                @endif
            </div>
        </div>
