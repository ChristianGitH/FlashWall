...
<x-card title="Moderation is desactivated !" subtitle="All images are beeing displayed." separator class="w-96 shadow-md lg:-mt-7">
            <a href="../setup-wall/{{ $wall->id }}"><x-toggle label="{{__('Check Settings page to activate')}}" wire:model="activate_moderation" disabled right inline/></a>
</x-card>
</div>
