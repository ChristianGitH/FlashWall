        ...
        <section class="mt-8 rounded-3xl border border-purple-100 bg-white/80 p-6 shadow-[0_20px_60px_-20px_rgba(168,85,247,0.25)] backdrop-blur dark:border-gray-800 dark:bg-gray-900/70 sm:p-8">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                ...
                <p class="max-w-2xl text-lg text-gray-600 dark:text-gray-300">
                    A smooth experience for guests and complete control for organizers.
                </p>
            </div>
            ...
            <div class="mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                <article class="rounded-2xl border border-gray-200 bg-gradient-to-br from-purple-50 to-pink-50 p-5 transition-transform duration-300 hover:-translate-y-1 dark:border-gray-700 dark:from-gray-800 dark:to-gray-800/90">
                    ...
                    <h4 class="mt-4 text-lg font-semibold text-gray-900 dark:text-white">1. Scan the QR code</h4>
                    <p class="mt-2 text-sm leading-6 text-gray-600 dark:text-gray-300">
                        Guests scan a QR code or click a link, and instantly access the experience.
                    </p>
                </article>
                ...
                <article class="rounded-2xl border border-gray-200 bg-white/70 p-5 transition-transform duration-300 hover:-translate-y-1 dark:border-gray-700 dark:bg-gray-900/70">
                    ...
                    <h4 class="mt-4 text-lg font-semibold text-gray-900 dark:text-white">2. Submit a photo</h4>
                    <p class="mt-2 text-sm leading-6 text-gray-600 dark:text-gray-300">
                        In just seconds, the audience shares a memory, moment, or emotion.
                    </p>
                </article>
                ...
                <article class="rounded-2xl border border-gray-200 bg-white/70 p-5 transition-transform duration-300 hover:-translate-y-1 dark:border-gray-700 dark:bg-gray-900/70">
                    ...
                    <h4 class="mt-4 text-lg font-semibold text-gray-900 dark:text-white">3. The organizer moderates - or not</h4>
                    <p class="mt-2 text-sm leading-6 text-gray-600 dark:text-gray-300">
                        Every submission can be approved or rejected in a single click to preserve the right atmosphere.
                    </p>
                </article>
                ...
                <article class="rounded-2xl border border-gray-200 bg-white/70 p-5 transition-transform duration-300 hover:-translate-y-1 dark:border-gray-700 dark:bg-gray-900/70">
                    ...
                    <h4 class="mt-4 text-lg font-semibold text-gray-900 dark:text-white">4. Photos appear on the screen</h4>
                    <p class="mt-2 text-sm leading-6 text-gray-600 dark:text-gray-300">
                        Approved content appears live on the big screen.
                    </p>
                </article>
            </div>
        </section>
            ...
            <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    ...
                    <h3 class="mt-2 text-2xl font-bold">
                        Create a free account and set up your first wall in minutes
                    </h3>
                    <p class="mt-3 max-w-2xl text-lg text-purple-50/90">
                        See how Flashwall works in practice, personalize your experience, and prepare your event with no commitment.
                    </p>
                </div>
        ...
        <section class="mt-8 rounded-3xl border border-white-200 p-6 shadow-[0_20px_60px_-20px_rgba(217,70,239,0.25)] sm:p-8">
            <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    ...
                    <h3 class="mt-2 text-2xl font-bold text-gray-900 dark:text-white">
                        Tailor every detail to your event identity
                    </h3>
                </div>
                <div class="rounded-full bg-white/80 px-4 py-2 text-sm font-semibold text-gray-700 shadow-sm dark:bg-gray-800/80 dark:text-gray-200">
                    Colors • Layout • Animations • Backgrounds
                </div>
            </div>
            <p class="mt-5 text-lg leading-8 text-gray-700 dark:text-gray-300">
                An experience that blends seamlessly with your event. With the most advanced customization options, you can shape the visual identity of your wall from the screen display to the user onboarding and get exactly what you want.
            </p>
            ...
            <p class="mt-5">
                ...
                <span class="text-lg leading-8 text-gray-700 dark:text-gray-300"> to check all available settings.</span>
            </p>
        </section>
