...
class WallSeeder extends Seeder
{
    public function run(): void
    {
        Wall::create([
            ...
            'submitter_name_font_color' => '#ffffff',
            'submitter_name_font_size' => '16',
            ...
            'posting_page_end_title' => 'Thank you!',
            'posting_page_end_text' => 'The submission was successful.',
            'posting_page_font' => '',
