...
return [
    ...
    'attributes'           => [
        ...
        'body'                     => 'corps',
        'caption_background_color' => 'couleur d\'arrière-plan',
        'caption_font_size'        => 'taille de la police des légendes',
        'caption_font_color'       => 'couleur de la police',
        'caption_max_characters'   => 'nombre max de caractère',
        'caption_max_width'   => 'largeur max des légendes',
        'city'                     => 'ville',
        'company'                  => 'company',
        ...
        'login'                    => 'identifiant',
        'max_images_user'          => 'nombre d\'images max par utilisateur ',
        'message'                  => 'message',
        ...
        'value'                    => 'valeur',
        'vertical_borders_width'   => 'marges verticales',
        'horizontal_borders_width' => 'marges horizontales',
        'winner'                   => 'winner',
        'work'                     => 'work',
        'year'                     => 'année',
    ],
