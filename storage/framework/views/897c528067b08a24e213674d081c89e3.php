...
<?php $component->withAttributes(['@click' => 'if (selectedApproved.length === 0) { 
                    ...
                    modalMessage = \''.e(__('You are about to archive')).' \' + selectedApproved.length + \' '.e(__('images.')).'\';
                    modalConfirmText = \''.e(__('Yes, archive !')).'\';
                    modalConfirmClass = \'bg-blue-600 hover:bg-blue-700\';
                    showConfirmModal = true; 
                    confirmAction = () => { 
                        errorMessage = \'\'; 
                        $wire.call(\'archiveSelected\', selectedApproved);
                        showConfirmModal = false;
                    };
                }
...
<?php endif; ?>
    ...
    <!-- Fenêtre modale de confirmation avant action -->
