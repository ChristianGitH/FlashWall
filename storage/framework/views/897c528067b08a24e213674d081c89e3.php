...
<div x-data="{ selectedApproved: [], allSelectedApproved: false, errorMessage : '',
        ...
        confirmAction: null  }" @reset-selection-approved.window="selectedApproved = []; allSelectedApproved = false">
...
<?php $component->withAttributes(['@click' => '
                if (selectedApproved.length === 0) { 
                    ...
                    modalMessage = \''.e(__('You are about to delete')).' \' + selectedApproved.length + \' '.e(__('images.')).'\';
                    modalConfirmText = \''.e(__('Yes, delete !')).'\';
                    modalConfirmClass = \'bg-red-600 hover:bg-red-700\';
                    showConfirmModal = true; 
                    confirmAction = () => { 
                        errorMessage = \'\'; 
                        $wire.call(\'deleteSelected\', selectedApproved);
                        showConfirmModal = false;
                    };
                }
...
<?php $attributes = $attributes->except(\Mary\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'archiveSelected','class' => 'btn btn-sm','aria-label' => ''.e(__('Archive Selected')).'','@click' => '$wire.set(\'selectedImages\', selectedApproved)']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal602b228a887fab12f0012a3179e5b533)): ?>
<?php $attributes = $__attributesOriginal602b228a887fab12f0012a3179e5b533; ?>
...
<?php endif; ?>
    ...
    <!-- Fenêtre modale dynamique (Suppression) -->
