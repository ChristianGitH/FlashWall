...
<?php endif; ?>
    ...
    <div class="relative leading-tight" style="min-width: max-content;">
        <p class="text-right">
            ...
            <br />
            <span style="top: 25px;" class=" absolute mb-3 text-gray-500 dark:text-gray-400">beta</span>
        </p>
...
<?php endif; ?>
    ...
    </a><?php /**PATH C:\laragon\www\FlashWall\storage\framework\views/f4505e5dcc85528b8bbee64437f3dc44.blade.php ENDPATH**/ ?>