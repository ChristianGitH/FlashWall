...
<?php endif; ?>
    ...
    <div class="relative leading-tight" style="min-width: max-content;">
        <p class="text-right">
            ...
            <br />
            <span style="top: 25px; right: 0px;" class=" absolute mb-3 text-gray-600 dark:text-gray-400">beta</span>
        </p>
...
<?php endif; ?>
    ...
    </a><?php /**PATH C:\laragon\www\FlashWall\storage\framework\views/c456ab8b91202e2d2073c69b64b1af12.blade.php ENDPATH**/ ?>