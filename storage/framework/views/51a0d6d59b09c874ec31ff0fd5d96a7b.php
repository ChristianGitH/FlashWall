...
<?php $component->withAttributes(['@click' => '
                if (selectedArchived.length === 0) { 
                    errorMessage = \''.e(__('No images selectedArchived.')).'\'; 
...
<?php $attributes = $attributes->except(\Mary\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'approveImage('.e($image->id).')','class' => 'btn btn-sm','aria-label' => ''.e(__('Approve image')).'','@click' => '$wire.set(\'selectedImages\', selectedArchived)']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal602b228a887fab12f0012a3179e5b533)): ?>
<?php $attributes = $__attributesOriginal602b228a887fab12f0012a3179e5b533; ?>
