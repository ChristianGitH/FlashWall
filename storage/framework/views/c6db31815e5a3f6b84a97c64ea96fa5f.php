...
<?php endif; ?>
    ...
    <div class="relative leading-tight" style="min-width: max-content;">
        <p class="text-right">
            <span style="top: px;" class=" absolute mb-3 text-gray-500 dark:text-gray-400">beta</span>
            <br />
...
<?php endif; ?>
    ...
    </a><?php /**PATH C:\laragon\www\FlashWall\storage\framework\views/a2446f2a7428df5cf10e6d677125153a.blade.php ENDPATH**/ ?>