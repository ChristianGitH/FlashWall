...
<?php endif; ?>
    ...
    <div class="relative leading-tight" style="min-width: max-content;">
        ...
        <span class="absolute -top-5 mb-3 right text-gray-500 dark:text-gray-400">
            beta
        </span>
    </div>
</div>
...
<?php endif; ?>
    ...
    </a><?php /**PATH C:\laragon\www\FlashWall\storage\framework\views/2bd6bcffea9edf845593cffb444467e7.blade.php ENDPATH**/ ?>