...
<?php endif; ?>
    ...
    <div class="relative leading-tight" style="min-width: max-content;">
        ...
        <div class="absolute top-0 text-[10px] text-warning mt-0.5">
            beta
        </div>
    </div>
</div>
...
<?php endif; ?>
    ...
    </a><?php /**PATH C:\laragon\www\FlashWall\storage\framework\views/b9aabc16ffc656199fad87321dc236a1.blade.php ENDPATH**/ ?>