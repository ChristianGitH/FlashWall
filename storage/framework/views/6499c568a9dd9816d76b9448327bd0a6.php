...
<?php $component = Mary\View\Components\Button::resolve(['label' => ''.e(__('Créer')).'','icon' => 'o-plus','spinner' => 'createWall'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
