...
<?php endif; ?>
    ...
    <div class="relative leading-tight" style="min-width: max-content;">
        <p class="text-right">
            <span style="top: 0px;" class=" absolute mb-3 text-gray-500 dark:text-gray-400">beta</span>
            <br />
...
<?php endif; ?>
    ...
    </a><?php /**PATH C:\laragon\www\FlashWall\storage\framework\views/56c9ac5f8a8997d19f4ae9371df762cb.blade.php ENDPATH**/ ?>