...
<?php endif; ?>
    ...
    <div class="relative leading-tight" style="min-width: max-content;">
        <p class="font-bold text-3xl bg-gradient-to-r from-purple-500 to-pink-300 bg-clip-text text-transparent">
            Flashwall                    <span class="absolute top-px-1 mb-3 text-gray-500 dark:text-gray-400">
            beta
        </span>
        </p>
...
<?php endif; ?>
    ...
    </a><?php /**PATH C:\laragon\www\FlashWall\storage\framework\views/9b576b0193ef1221e78b0a40ab72f4e9.blade.php ENDPATH**/ ?>