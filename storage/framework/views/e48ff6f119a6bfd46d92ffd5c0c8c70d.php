...
<?php endif; ?>
    ...
    <div class="relative leading-tight" style="min-width: max-content;">
        ...
        <div class="absolute top-5 text-3xl text-warning mt-0.4">
            beta
        </div>
    </div>
</div>
...
<?php endif; ?>
    ...
    </a><?php /**PATH C:\laragon\www\FlashWall\storage\framework\views/f94fa310fd5dca5cb68f46f09ee70efa.blade.php ENDPATH**/ ?>