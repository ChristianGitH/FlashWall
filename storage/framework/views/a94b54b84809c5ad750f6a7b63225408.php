...
<?php endif; ?>
    ...
    <div class="relative leading-tight" style="min-width: max-content;">
        ...
        <div class="absolute top-5 text-1s text-warning mt-0.4">
            beta
        </div>
    </div>
</div>
...
<?php endif; ?>
    ...
    </a><?php /**PATH C:\laragon\www\FlashWall\storage\framework\views/efcccef5be39db1871f7a2461facf68f.blade.php ENDPATH**/ ?>