 <main @class(["w-full mx-auto flex-1 flex flex-col", "max-w-screen-2xl" => !$fullWidth])>
    <div @class([
        ...
        <div {{ $content->attributes->class(["drawer-content w-full flex flex-col flex-1 mx-auto p-5 lg:px-10 lg:py-5"]) }}>
            <!-- MAIN CONTENT -->
            {{ $content }}
        </div>
