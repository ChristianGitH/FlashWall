 <main class="<?php echo \Illuminate\Support\Arr::toCssClasses(["w-full mx-auto flex-1 flex flex-col", "max-w-screen-2xl" => !$fullWidth]); ?>">
    <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
        ...
        <div <?php echo e($content->attributes->class(["drawer-content w-full flex flex-col flex-1 mx-auto p-5 lg:px-10 lg:py-5"])); ?>>
            <!-- MAIN CONTENT -->
            <?php echo e($content); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\FlashWall\storage\framework\views/3d1474fdc79e56268ca22f004ef5c344.blade.php ENDPATH**/ ?>