...
<?php endif; ?>
    ...
    <div class="relative leading-tight" style="min-width: max-content;">
        ...
        <div class="absolute top-2.2 text-[10px] text-warning mt-0.5">
            beta
        </div>
    </div>
</div>
...
<?php endif; ?>
    ...
    </a><?php /**PATH C:\laragon\www\FlashWall\storage\framework\views/2fb6ccd65e311efd828a341dbb1be50a.blade.php ENDPATH**/ ?>