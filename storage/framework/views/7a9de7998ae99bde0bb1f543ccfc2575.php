 <main class="<?php echo \Illuminate\Support\Arr::toCssClasses(["w-full h-full mx-auto", "max-w-screen-2xl" => !$fullWidth]); ?>">
    <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
        "drawer h-full lg:drawer-open",
        ...
        <div <?php echo e($content->attributes->class(["drawer-content w-full h-full mx-auto p-5 lg:px-10 lg:py-5"])); ?>>
            <!-- MAIN CONTENT -->
            <?php echo e($content); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\FlashWall\storage\framework\views/ea397132e64c5ce4f9834e271482503e.blade.php ENDPATH**/ ?>