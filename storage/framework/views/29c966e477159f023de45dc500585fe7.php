...
<?php endif; ?>
    ...
    <div class="relative leading-tight" style="min-width: max-content;">
        ...
        <span class="absolute inset-[1px] mb-3 right text-gray-500 dark:text-gray-400">
            beta
        </span>
    </div>
</div>
...
<?php endif; ?>
    ...
    </a><?php /**PATH C:\laragon\www\FlashWall\storage\framework\views/f0982903e81a1e930a8731d2be783d30.blade.php ENDPATH**/ ?>