...
<?php endif; ?>
    ...
    <div class="relative leading-tight" style="min-width: max-content;">
        <p class="text-right">
            ...
            <br />
            <span style="top: -2px; left: 20px;" class=" absolute mb-3 text-gray-500 dark:text-gray-400">beta</span>
        </p>
...
<?php endif; ?>
    ...
    </a><?php /**PATH C:\laragon\www\FlashWall\storage\framework\views/fe622de26db3d59fafc21358fcc54671.blade.php ENDPATH**/ ?>