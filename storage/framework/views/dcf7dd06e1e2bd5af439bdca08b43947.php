...
<?php endif; ?>
    ...
    <div class="relative leading-tight" style="min-width: max-content;">
        <p class="text-right">
            ...
            <br />
            <span class="right-[-80px] absolute mb-3 text-gray-500 dark:text-gray-400">beta</span>
        </p>
...
<?php endif; ?>
    ...
    </a><?php /**PATH C:\laragon\www\FlashWall\storage\framework\views/5a2d46834a3bcffc6ae23aedc26d7c3b.blade.php ENDPATH**/ ?>