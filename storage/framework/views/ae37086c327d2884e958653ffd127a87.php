...
<?php endif; ?>
    ...
    <div class="relative leading-tight" style="min-width: max-content;">
        ...
        <div class="absolute top-10 text-[10px] text-warning mt-0.5">
            beta
        </div>
    </div>
</div>
...
<?php endif; ?>
    ...
    </a><?php /**PATH C:\laragon\www\FlashWall\storage\framework\views/95809892fddf51755982874cdbebead9.blade.php ENDPATH**/ ?>