...
<?php endif; ?>
    ...
    <div class="relative leading-tight" style="min-width: max-content;">
        <p class="text-right">
            ...
            <br />
            <span style="top: -2px; right: 20px;" class=" absolute mb-3 text-gray-500 dark:text-gray-400">beta</span>
        </p>
...
<?php endif; ?>
    ...
    </a><?php /**PATH C:\laragon\www\FlashWall\storage\framework\views/f9a259989ee1b551daa3a786ce6dbdaf.blade.php ENDPATH**/ ?>